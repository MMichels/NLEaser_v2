...
from nleaser_api.request_models.ngram_models import post_model, post_response_model, get_response_model, \
    delete_response_model, ngram_model, get_model

from nleaser_models.nlp.ngrams import ExtractedNGramsSchema
from nleaser_models.tasks.ngrams import NGramsCreateTaskSchema

from nleaser_sources.app_services.ngrams import NGramsAppService
...
class NGramsResource(Resource):
    ...
    def post(self, datafile_id: str):
        ...
        service = NGramsAppService(datafile_id)
