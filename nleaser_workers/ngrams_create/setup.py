...
setup(
    name="nleaser_worker_ngrams_create_extract-NLEaser",
    version=get_version(),
    ...
    packages=find_packages(
        where="../../../NLEaser_v2",
        exclude=[
            "nleaser_api*", "nleaser_workers.wordcloud_create",
            "nleaser_workers.sentence_import", "nleaser_workers.ner_extract"
        ],
    ),
